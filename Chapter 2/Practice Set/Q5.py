...
a = input("Enter 1st no:")#Takes the input from user as a "String" to use that value as int or float 
...
b = input("Enter 2nd no:")#Takes the input from user as a "String" to use that value as int or float 
                                    # You will have to Typecast it to int or float
