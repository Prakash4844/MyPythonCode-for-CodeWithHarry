...
class Person:
    ...
    def breath(self):
        # 3. This method is ran by super() of employee and control return to employee
...
class Employee(Person):
    ...
    def getSalary(self):
        print(f"{company} is a TATA Company.")

    def breath(self):
        super().breath()  
        # super() Method is used to access the super/Parent class of a derived class
